...
public class Expediente extends AppCompatActivity {
    Spinner spEstados;
    Button btncerrar,btnActualizarEst;
    ...
    String EstaSeleccionado,EstadoActual,RespuestaEstado;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Boton para actualizar el estado de la cita
        btnActualizarEst.setOnClickListener(new View.OnClickListener() {
            ...
            //    https://apiapp.misalud.com.sv/citas/cambiar_estado?user=administrador&pass=admin0614&idestado=5&idreservacita=41407
